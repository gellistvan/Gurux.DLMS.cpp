...
typedef enum
{
    ...
    // user information result errors
    DLMS_ERROR_CODE_MEMORY_UNAVAILABLE,
    DLMS_ERROR_CODE_MASS_STORAGE_UNAVAILABLE,
    DLMS_ERROR_CODE_OTHER_RESOURCE_UNAVAILABLE,
    DLMS_ERROR_CODE_NO_DLMS_CONTEXT,
    DLMS_ERROR_CODE_LOADING_DATA_SET,
    DLMS_ERROR_CODE_STATUS_NOCHANGE,
    DLMS_ERROR_CODE_STATUS_INOPERABLE,
    DLMS_ERROR_CODE_PDU_SIZE,
    DLMS_ERROR_CODE_SERVICE_UNSUPPORTED,
    DLMS_ERROR_CODE_OBJECT_UNDEFINED,
    DLMS_ERROR_CODE_OBJECT_CLASS_INCONSISTENT,
    DLMS_ERROR_CODE_OBJECT_ATTRIBUTE_INCONSISTENT,
    DLMS_ERROR_CODE_SCOPE_OF_ACCESS_VIOLATED,
    DLMS_ERROR_CODE_OBJECT_ACCESS_INVALID,
    DLMS_ERROR_CODE_OBJECT_UNAVAILABLE,
    DLMS_ERROR_CODE_DLMS_VERSION_TOO_LOW,
    DLMS_ERROR_CODE_INCOMPATIBLE_CONFORMANCE,
    DLMS_ERROR_CODE_PDU_SIZE_TOO_SHORT,
    DLMS_ERROR_CODE_REFUSED_BY_THE_VDEHANDLER,
    DLMS_ERROR_CODE_PRIMITIVE_OUT_OF_SEQUENCE,
    DLMS_ERROR_CODE_NOT_LOADABLE,
    DLMS_ERROR_CODE_DATASET_SIZE_TOO_LARGE,
    DLMS_ERROR_CODE_NOT_AWAITED_SEGMENT,
    DLMS_ERROR_CODE_INTERPRETATION_FAILURE,
    DLMS_ERROR_CODE_STORAGE_FAILURE,
    DLMS_ERROR_CODE_DATA_SET_NOT_READY,
    DLMS_ERROR_CODE_NO_REMOTE_CONTROL,
    DLMS_ERROR_CODE_TI_STOPPED,
    DLMS_ERROR_CODE_TI_RUNNING,
    DLMS_ERROR_CODE_TI_UNUSABLE
}DLMS_ERROR_CODE;
