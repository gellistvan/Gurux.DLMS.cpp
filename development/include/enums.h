...
typedef enum
{
  DLMS_SERVICE_ERROR_SOURCE_HARDWARE_RESOURCE = 1,
  DLMS_SERVICE_ERROR_SOURCE_VDE_STATE_ERROR = 2,
  DLMS_SERVICE_ERROR_SOURCE_SERVICE = 3,
  DLMS_SERVICE_ERROR_SOURCE_DEFINITION = 4,
  DLMS_SERVICE_ERROR_SOURCE_ACCESS = 5,
  DLMS_SERVICE_ERROR_SOURCE_INITIATE = 6,
  DLMS_SERVICE_ERROR_SOURCE_LOAD_DATASET = 7,
  DLMS_SERVICE_ERROR_SOURCE_TASK = 8
} DLMS_SERVICE_ERROR_SOURCE;


typedef enum
{
  HARDWARE_RESOURCE_OTHER = 0,
  MEMORY_UNAVAILABLE = 1,
  MASS_STORAGE_UNAVAILABLE = 2,
  OTHER_RESOURCE_UNAVAILABLE = 3,
} DLMS_SERIVCE_ERROR_HARDWARE_RESOURCE_TYPE;

typedef enum
{
  VDE_STATE_ERROR_OTHER = 0,
  NO_DLMS_CONTEXT = 1,
  LOADING_DATA_SET = 2,
  STATUS_NOCHANGE = 3,
  STATUS_INOPERABLE = 4,
} DLMS_SERIVCE_ERROR_VDE_STATE_ERROR_TYPE;
...
} DLMS_SERIVCE_ERROR_SERVICE_TYPE;
...
} DLMS_SERIVCE_ERROR_DEFINITION_TYPE;
...
} DLMS_SERIVCE_ERROR_ACCESS_TYPE;
...
typedef enum
{
  ...
  REFUSED_BY_THE_VDEHANDLER = 4,
} DLMS_SERIVCE_ERROR_INITIATE_TYPE;

typedef enum
{

  LOAD_DATA_SET_OTHER = 0,
...
} DLMS_SERIVCE_ERROR_LOAD_DATA_SET_TYPE;
